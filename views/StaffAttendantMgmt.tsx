        ...
        <div className="lg:col-span-2 space-y-6 pr-4">
          ...
          {activeAttendants.map((att) => (
            <div 
              ...
              className={`p-6 sm:p-10 rounded-[2.5rem] sm:rounded-[3.5rem] border-2 transition-all cursor-pointer group flex flex-col sm:flex-row items-center justify-between gap-8 shadow-lg hover:shadow-2xl ${s.card} ${selectedAttendant?.id === att.id ? 'ring-4 ring-[#0A84FF] scale-[1.02]' : 'hover:scale-[1.01] active:scale-95'}`}
            >
